...
In subsequent test runs, the same CAST API calls or directives are used to compare the intermediate results in the running program against the reference results previously saved.
